...
В случае использования visitType с одним externalVisitId создается два визита с одниковым externalVisitId, которые связанны между собой. Это позволяет указывать при интеграции один визит, разделяя по типу "до" и "после".
