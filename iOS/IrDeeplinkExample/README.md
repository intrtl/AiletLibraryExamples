...
- [Взаимодействие с приложением Intelligence Retail с помощью deeplinks.](#взаимодействие-с-приложением-intelligence-retail-с-помощью-deeplinks)
  ...
  - [Примеры использования](#примеры-использования)
    - [Использование метода sync для контроля синхронизации](#использование-метода-sync-для-контроля-синхронизации)
...
### Использование метода sync для контроля синхронизации
